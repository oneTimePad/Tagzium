...
public class ReloginBox {
    ...
    public void show(final ArrayList<Object> args,final Callback fct) {
        ...
        final Button submit = new Button(ctx);
        ...
        final RelativeLayout.LayoutParams progparams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
